...
<div class="row">
    ...
    <form:form modelAttribute="cart" cssClass="w-50 mx-auto p-2 border border-warning rounded col-3" 
        ...
        <div class="form-group">
            ...
            <form:input cssClass="form-control" path="RecipientName" value="${user.name}" readonly="readonly"/>
        </div>
        <div class="form-group">
            <label>Địa chỉ người nhận: </label>
            <form:input class="form-control" path="RecipientAddress" value="${user.address}" readonly="readonly"/>
        </div>
        <div class="form-group">
            <label>Số điện thoại người nhận: </label>
            <form:input class="form-control" path="RecipientPhone" value="${user.phone}" readonly="readonly"/>
        </div>
    </form:form>
</div>
<div style="text-align: center;">
    <a href="${pageContext.request.contextPath}/order/cart_view" class="btn btn-secondary">Quay lại giỏ hàng</a>
    <button form="cart" type="submit" class="btn btn-success ml-2">Hoàn tất đơn hàng</button>
</div>
