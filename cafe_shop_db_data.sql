use cafe_shop_db
insert into Product values(N'PHINDI CHOCO',
...
1)
insert into Product values(N'BẠC XỈU ĐÁ',
...
1)
insert into Product values(N'PHIN ĐEN ĐÁ',
...
1)
insert into Product values(N'PHIN ĐEN NÓNG',
...
1)
insert into Product values(N'PHIN SỮA ĐÁ',
...
1)
insert into Product values(N'PHIN SỮA NÓNG',
...
1)
insert into Product values(N'PHINDI HỒNG TRÀ',
...
1)
insert into Product values(N'PHINDI KEM SỮA',
...
insert into Image values(N'PHINDI CHOCO.png',1)
insert into Image values(N'BẠC XỈU ĐÁ.png',2)
insert into Image values(N'PHIN ĐEN ĐÁ.png',3)
insert into Image values(N'PHIN ĐEN NÓNG.png',4)
insert into Image values(N'PHIN SỮA ĐÁ.png',5)
